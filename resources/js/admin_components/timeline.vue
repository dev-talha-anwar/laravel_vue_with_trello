                                    ...
                                    <div class="col-md-5 col-sm-4">
                                        <div class="todo-tasklist">
                                            <div class="todo-tasklist-item todo-tasklist-item-border-green">
                                                <img class="todo-userpic pull-left" :src=adminassets"/pages/media/users/avatar4.jpg" width="27px" height="27px">
                                            ...
                                            <div class="todo-tasklist-item todo-tasklist-item-border-red">
                                                <img class="todo-userpic pull-left" :src=adminassets"/pages/media/users/avatar5.jpg" width="27px" height="27px">
                                            ...
                                            <div class="todo-tasklist-item todo-tasklist-item-border-green">
                                                <img class="todo-userpic pull-left" :src=adminassets"/pages/media/users/avatar9.jpg" width="27px" height="27px">
                                                <div class="todo-tasklist-item-title"> Slider Redesign </div>
                                                <div class="todo-tasklist-controls pull-left">
                                                    <span class="todo-tasklist-date">
                                            ...
                                            <div class="todo-tasklist-item todo-tasklist-item-border-blue">
                                                <img class="todo-userpic pull-left" :src=adminassets"/pages/media/users/avatar6.jpg" width="27px" height="27px">
                                            ...
                                            <div class="todo-tasklist-item todo-tasklist-item-border-purple">
                                                <img class="todo-userpic pull-left" :src=adminassets"/pages/media/users/avatar7.jpg" width="27px" height="27px">
                                            ...
                                            <div class="todo-tasklist-item todo-tasklist-item-border-yellow">
                                                <img class="todo-userpic pull-left" :src=adminassets"/pages/media/users/avatar8.jpg" width="27px" height="27px">
                                            ...
                                            <div class="form">
                                                <div class="form-group">
                                                    <div class="col-md-8 col-sm-8">
                                                        <div class="todo-taskbody-user">
                                                            <img class="todo-userpic pull-left" :src=adminassets"/pages/media/users/avatar6.jpg" width="50px" height="50px">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        </select><span class="select2 select2-container select2-container--bootstrap" dir="ltr" style="width: 520px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-snm7-container"><span class="select2-selection__rendered" id="select2-snm7-container" title="Pending">Pending</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                    </div>
                                                </div>
                                                <!-- TASK TAGS -->
                                                                ...
                                                                <ul class="media-list">
                                                                    <li class="media">
                                                                        <a class="pull-left" href="javascript:;">
                                                                            <img class="todo-userpic" :src=adminassets"/pages/media/users/avatar8.jpg" width="27px" height="27px"> </a>
                                                                        <div class="media-body todo-comment">
                                                                            ...
                                                                            <div class="media">
                                                                                <a class="pull-left" href="javascript:;">
                                                                                    <img class="todo-userpic" :src=adminassets"/pages/media/users/avatar4.jpg" width="27px" height="27px"> </a>
                                                                    ...
                                                                    <li class="media">
                                                                        <a class="pull-left" href="javascript:;">
                                                                            <img class="todo-userpic" :src=adminassets"/pages/media/users/avatar5.jpg" width="27px" height="27px"> </a>
                                                                        <div class="media-body todo-comment">
                                                                            <button type="button" class="todo-comment-btn btn btn-circle btn-default btn-sm">&nbsp; Reply &nbsp;</button>
                                                                            <p class="todo-comment-head">
                                                                    ...
                                                                    <li class="media">
                                                                        <a class="pull-left" href="javascript:;">
                                                                            <img class="todo-userpic" :src=adminassets"/pages/media/users/avatar6.jpg" width="27px" height="27px"> </a>
                                                                        <div class="media-body todo-comment">
                                                                            <button type="button" class="todo-comment-btn btn btn-circle btn-default btn-sm">&nbsp; Reply &nbsp;</button>
                                                                            <p class="todo-comment-head">
