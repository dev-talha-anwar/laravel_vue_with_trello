...
<script src="{{asset('adminassets')}}/global/plugins/jquery.min.js" type="text/javascript"></script>
        ...
        {{-- <script src="{{asset('adminassets')}}/global/plugins/jquery.pulsate.min.js" type="text/javascript"></script> --}}
        ...
        {{-- <script src="{{asset('adminassets')}}/pages/scripts/ui-toastr.min.js" type="text/javascript"></script> --}}
